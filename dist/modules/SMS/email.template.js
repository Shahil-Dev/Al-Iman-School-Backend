...
exports.getFeeReminderEmailTemplate = exports.getAbsenceEmailTemplate = void 0;
// ১. অনুপস্থিতির নোটিশের জন্য সুন্দর HTML টেমপ্লেট
const getAbsenceEmailTemplate = (studentName, className, dateStr) => {
    return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
...
exports.getAbsenceEmailTemplate = getAbsenceEmailTemplate;
// ২. বকেয়া ফি রিমাইন্ডারের জন্য সুন্দর HTML টেমপ্লেট
const getFeeReminderEmailTemplate = (studentName, invoiceNo, dueAmount, dueDateStr) => {
    return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
...
exports.getFeeReminderEmailTemplate = getFeeReminderEmailTemplate;
